                        ...
                        <div class="about-right mb-90">
                            ...
                            <div class="social-share pt-30">
                                <div class="section-tittle">
                                    ...
                                    <ul>
                                        <li><a href="#"><img src="<%= request.getContextPath() %>/../../assets/img/news/icon-ins.png" alt=""></a></li>
                                        <li><a href="#"><img src="<%= request.getContextPath() %>/../../assets/img/news/icon-fb.png" alt=""></a></li>
                                        <li><a href="#"><img src="<%= request.getContextPath() %>/../../assets/img/news/icon-tw.png" alt=""></a></li>
                                        <li><a href="#"><img src="<%= request.getContextPath() %>/../../assets/img/news/icon-yo.png" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="single-follow mb-45">
                            <div class="single-box">
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="<%= request.getContextPath() %>/../../assets/img/news/icon-tw.png" alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                                        <p>Fans</p>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="<%= request.getContextPath() %>/../../assets/img/news/icon-ins.png" alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                                        <p>Fans</p>
                                ...
                                <div class="follow-us d-flex align-items-center">
                                    <div class="follow-social">
                                        <a href="#"><img src="<%= request.getContextPath() %>/../../assets/img/news/icon-yo.png" alt=""></a>
                                    </div>
                                    <div class="follow-count">
                                        <span>8,045</span>
                                        <p>Fans</p>
